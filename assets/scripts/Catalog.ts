...
export const CARS: Record<CarType, { name: string; description: string; color: string; role: CarRole }> = {
  ...
  fan: { name: '风扇车', description: '独立推开普通敌人，并为两侧相邻攻击车输送气流。', color: '#94BDA5', role: 'buff' },
  tesla: { name: '电弧车', description: '自动电击最近的三个目标；相邻辅助车可强化电弧。', color: '#E1BF79', role: 'offense' },
  cryo: { name: '冰霜车', description: '独立造成低额冰伤并减速普通敌人，为相邻攻击车附加冰霜效果。', color: '#B5D3BE', role: 'debuff' },
  rail: { name: '轨道炮车', description: '射出整束磁轨光束，瞬间贯穿直线上的敌群。', color: '#D6B99D', role: 'offense' },
  prism: { name: '棱镜车', description: '零伤害折光脉冲，为相邻进攻车分裂攻击。', color: '#F0D6A0', role: 'buff' },
